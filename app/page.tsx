        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-gray-300 text-lg mb-10 leading-relaxed">
              En Storm, te equipamos para enfrentar cualquier desafío.
              Descubre nuestra colección de ropa y calzado deportivo
              diseñada para potenciar tu rendimiento y estilo, tanto
              dentro como fuera del campo. Ya sea que entrenes,
              compitas o simplemente vivas con.
            </p>
